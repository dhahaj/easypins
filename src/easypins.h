...
class EasyPins {
	public:
		 ...
		 */
		EasyPins(uint8_t number, uint8_t offset, uint8_t timer, volatile uint8_t* PIN, volatile uint8_t* PORT, volatile uint8_t* DDR) {
			_number = number;
			_offset = offset;
			_ioffset = ~_offset;
			_timer = timer;
